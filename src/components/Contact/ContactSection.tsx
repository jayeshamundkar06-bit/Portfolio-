...
import { Mail, Phone, MapPin, Github, Send, ArrowRight } from "lucide-react";
        ...
        <div className="glass-panel rounded-[2rem] p-8 sm:p-12 md:p-16 text-center hover:border-accent/40 transition-all duration-700 shadow-2xl relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10 max-w-2xl mx-auto text-left">
            {contactItems.map((item, idx) => (
              <a
                ...
                className="glass-panel rounded-2xl p-4 sm:p-5 flex items-center gap-4 hover:border-white/30 transition-all duration-300 group"
              >
                <div
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2.5 px-8 py-4 bg-white/[0.05] hover:bg-white/[0.1] text-white border border-white/[0.1] hover:border-white/[0.2] font-bold rounded-full transition-all duration-300 backdrop-blur-md text-sm sm:text-base"
            >
